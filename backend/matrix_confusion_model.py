...
TEST_DATA_PATH = os.path.abspath('Test_Data')  # Carpeta donde están los datos de prueba

def plot_individual_confusion_matrices(cm, actions, output_dir='Matrix_Confusions'):
    """
