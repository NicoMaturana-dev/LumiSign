...
DATA_PATH = os.path.abspath('MP_Data_Videos')  # Ruta absoluta para evitar conflictos
LOGS_PATH = os.path.abspath('Logs_Videos')  # Ruta absoluta para los logs
TEST_DATA_PATH = os.path.abspath('Test_Data_Videos')  # Carpeta para datos de prueba
...
#Normalizar la secuencia entre [-1, 1]
...
# Guardar el modelo
model.save('train_model_videos.keras')
